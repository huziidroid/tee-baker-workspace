import { MutationFunction, MutationKey, MutationOptions, QueryFunction, QueryKey, UseQueryOptions } from '@tanstack/react-query';
...
export type QueryArgs<TQueryData, TSelectData = TQueryData> = {
  ...
  options?: Omit<
    UseQueryOptions<AxiosResponse<QueryResponse<TQueryData>>, AxiosError<QueryErrorResponse>>,
...
export type MutationArgs<TData, TVariables> = {
  ...
  options?: Omit<
    ...
    'onMutate' | 'onSuccess' | 'onError' | 'onSettled' | 'mutationFn' | 'mutationKey'
  >;
};
